...
M.load_config = function()
  ...
  if vimrc_path then
    ...
    config.mappings = M.remove_disabled_keys(vimrc.mappings, config.mappings)
    config = merge_tb("force", config, vimrc)
...
M.remove_disabled_keys = function(vimrc_mappings, default_mappings)
  ...
  for _, mappings in pairs(vimrc_mappings) do
...
M.load_mappings = function(section, mapping_opt)
  vim.schedule(function()
    ...
    local mappings = require("config.utils").load_config().mappings
